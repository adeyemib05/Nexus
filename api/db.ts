  ...
  try {
    const counts = await querySql(`
      SELECT 
        ...
        (SELECT count(*) FROM indicator_snapshots) as indicator_snapshots,
        (SELECT count(*) FROM signal_snapshots) as signal_snapshots,
        (SELECT count(*) FROM ai_decisions) as ai_decisions,
