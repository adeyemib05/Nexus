...
export const REGIME_CONFIG = {
  bullish_trend: {
    label: 'Bullish Trend', color: '#10B981',
    bgColor: 'rgba(16,185,129,0.1)', borderColor: 'rgba(16,185,129,0.3)',
    description: 'Strong upward momentum', strategy: 'Momentum Long',
  },
  bearish_trend: {
    label: 'Bearish Trend', color: '#EF4444',
    bgColor: 'rgba(239,68,68,0.1)', borderColor: 'rgba(239,68,68,0.3)',
    description: 'Strong downward pressure', strategy: 'Momentum Short',
  },
  ranging: {
    label: 'Ranging', color: '#F59E0B',
    bgColor: 'rgba(245,158,11,0.1)', borderColor: 'rgba(245,158,11,0.3)',
    description: 'Sideways, mean-reversion potential', strategy: 'Mean Reversion',
  },
  uncertain: {
    label: 'Uncertain', color: '#6B7280',
    bgColor: 'rgba(107,114,128,0.1)', borderColor: 'rgba(107,114,128,0.3)',
